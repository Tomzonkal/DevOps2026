...
from model_422971 import model as model_422971
...
@app.route('/api/model_422971', methods=['POST'])
def model_422971_input():
    # Pobieranie treści zapytania w naszym przypadku array[4]
    data = request.get_json()
    input=data["input"]
    #Wykonywanie predykcji
    result=model_422971.run_model_422971(input=input)
    return jsonify({'result': result}), 200
