...
from model_420372 import model as model_420372
...
@app.route('/api/model_420372', methods=['POST'])
def model_420372_input():
    # Pobieranie treści zapytania w naszym przypadku array[4]
    data = request.get_json()
    input=data["input"]
    #Wykonywanie predykcji
    result=model_420372.run_model_420372(input=input)
    return jsonify({'result': result}), 200
