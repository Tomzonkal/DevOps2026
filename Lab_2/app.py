...
from model_422379 import model as model_422379
...
def model_v1_input():
    ...
    input = data["input"]
    result_v1 = model_422379.run_model_v1(input)
...
def model_v2_input():
    data = request.get_json()
    input = data["input"]
    result_v2 = model_422379.run_model_v2(input)
...
def model_v3_input():
    data = request.get_json()
    input = data["input"]
    result_v3 = model_422379.run_model_v3(input)
