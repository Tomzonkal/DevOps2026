...
from model_422380 import model
...
def model_v1_input():
    ...
    input = data["input"]
    result_v1 = model.run_model_422380_v1(input)
...
def model_v2_input():
    data = request.get_json()
    input = data["input"]
    result_v2 = model.run_model_422380_v2(input)
...
def model_v3_input():
    data = request.get_json()
    input = data["input"]
    result_v3 = model.run_model_422380_v3(input)
